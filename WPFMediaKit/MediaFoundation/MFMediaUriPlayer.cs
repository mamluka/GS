...
using WPFMediaKit.MediaFoundation.Interop.EVR;
using WPFMediaKit.MediaFoundation.Interop.Misc;

namespace WPFMediaKit.MediaFoundation
{
    public class MFMediaUriPlayer : COMBase, IMFAsyncCallback
    {
        #region externs
        ...
        ~MFMediaUriPlayer()
    {
        ...
        private EvrPresenter m_customPresenter;
        ...
        {
            Action newAllocatorFrameAction = NewAllocatorFrame;
        ...
        {
            NewAllocatorSurfaceDelegate Delegate = NewAllocatorSurface;
            if(Delegate != null) Delegate(this, pSurface);
        }

        void m_customPresenter_NewAllocatorSurface(object sender, IntPtr pSurface)
        {
            InvokeNewAllocatorSurface(pSurface);
        }

        void m_customPresenter_NewAllocatorFrame()
        {
