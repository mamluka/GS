...
namespace WPFMediaKit.MediaFoundation.Interop.Misc
{
    ...
    public class ConstPropVariant : IDisposable
    {
        ...
        [FieldOffset(8)] protected ushort uiVal;

        [FieldOffset(8)] protected byte bVal;

        [FieldOffset(8)] protected int intValue;

        [FieldOffset(8)] protected uint uintVal;

        [FieldOffset(8)] protected float fltVal;

        [FieldOffset(8)] protected long longValue;

        [FieldOffset(8)] protected ulong ulongValue;
    ...
    public class WaveFormatEx
    {
        ...
        public IntPtr GetPtr()
        {
            ...
            if(this is WaveFormatExtensibleWithData)
            {
                ...
                var pData = this as WaveFormatExtensibleWithData;
                ...
                var ip2 = new IntPtr(ip.ToInt64() + iExtensibleSize);
            ...
            else if(this is WaveFormatExtensible)
            {
                ...
                var pExt = this as WaveFormatExtensible;
            ...
            else if(this is WaveFormatExWithData)
            {
                ...
                var pData = this as WaveFormatExWithData;
                ...
                var ip2 = new IntPtr(ip.ToInt64() + iWaveFormatExSize);
        ...
        public static WaveFormatEx PtrToWave(IntPtr pNativeData)
        {
            ...
            if(wFormatTag != -2)
            {
                ...
                {
                    var dat = new WaveFormatExWithData();
                    ...
                    var ip2 = new IntPtr(pNativeData.ToInt64() + 18);
            ...
            else
            {
                ...
                {
                    var ext = new WaveFormatExtensibleWithData();
                    ...
                    var ip2 = new IntPtr(pNativeData.ToInt64() + Marshal.SizeOf(typeof(WaveFormatExtensible)));
    ...
    public class BitmapInfoHeader
    {
        ...
        public IntPtr GetPtr()
        {
            ...
            if(this is BitmapInfoHeaderWithData)
            {
                ...
                var pData = this as BitmapInfoHeaderWithData;
                ...
                var ip2 = new IntPtr(ip.ToInt64() + iBitmapInfoHeaderSize);
    ...
    public sealed class MFError
    {
        ...
        #region Nested type: FormatMessageFlags
        ...
        #region Nested type: LoadLibraryExFlags
    ...
    {
        private static readonly RTIMarshaler[] s_rti = new RTIMarshaler[2];
                ...
                if(m_array != null)
                {
                    ...
                    if(ip2 != IntPtr.Zero)
                    {
                        try
                        {
                            ...
                            {
                                var rti = new MFTRegisterTypeInfo();
    ...
    internal class RTAMarshaler : ICustomMarshaler
    {
        ...
        public IntPtr MarshalManagedToNative(object managedObj)
        {
            ...
            // Save off the object.  We'll be calling methods on this in
            // MarshalNativeToManaged.
            var array = managedObj as MFTRegisterTypeInfo[];
    ...
    internal class WEMarshaler : ICustomMarshaler
    {
        ...
        public IntPtr MarshalManagedToNative(object managedObj)
        {
            var wfe = managedObj as WaveFormatEx;
