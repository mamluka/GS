...
namespace WPFMediaKit.DirectShow.MediaPlayers
{
    ...
    public abstract class MediaPlayerBase : WorkDispatcherObject
    {
        ...
        /// </summary>
        private const int DSHOW_TIMER_POLL_MS = 250;
        ...
        public virtual double Balance
        {
            ...
            set
            {
                ...
                int dshowVolume = (int)value * DSHOW_BALACE_MAX_ABS;

                m_basicAudio.put_Balance(dshowVolume);
            }
        }
        ...
        {
            logger.FatalException(e.Message,e.Exception);
