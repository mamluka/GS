...
using NLog;
using WPFMediaKit.DirectShow.Interop.Dvd;
...
namespace WPFMediaKit.DirectShow.Interop
{
    ...
    public class DsLong
    {
        ...
        /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsLong.ToInt64"/> for similar functionality.
        /// <code>
        ...
        /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsGuid.FromInt64"/> for similar functionality.
        /// <code>
    ...
    public class DsGuid
    {
        ...
        /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsGuid.ToGuid"/> for similar functionality.
        /// <code>
        ...
        /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsGuid.FromGuid"/> for similar functionality.
        /// <code>
    ...
    public class DsInt
    {
      ...
      /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsInt.ToInt64"/> for similar functionality.
      /// <code>
      ...
      /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsGuid.FromInt32"/> for similar functionality.
      /// <code>
    ...
    public class DsShort
    {
      ...
      /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsShort.ToInt64"/> for similar functionality.
      /// <code>
      ...
      /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsGuid.FromInt16"/> for similar functionality.
      /// <code>
    ...
    public class DsRect
    {
        ...
        /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsRect.ToRectangle"/> for similar functionality.
        /// <code>
        ...
        /// VB.Net doesn't support implicit cast. <see cref="WPFMediaKit.DirectShow.Interop.DsRect.FromRectangle"/> for similar functionality.
        /// <code>
                    ...
                    try
                    {
...
#endif
                        {
                            try
                            {
                                ...
                                Guid classID;
                                mon[0].GetClassID(out classID);
                                logger.Info(classID.ToString());
