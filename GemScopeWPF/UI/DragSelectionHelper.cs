...
namespace GemScopeWPF.UI
{
...

    {
        ...
        // (this only happened in the project I'm working on, if you're using a regular ListBox, with regular StackPanels you can get the ListBox from the StackPanels)
